import {
  Scene
} from "./chunk-H7HFEJWJ.js";
import {
  ApplyPostProcess,
  CubeMapToSphericalPolynomialTools,
  PostProcess,
  SphericalPolynomial
} from "./chunk-RUM4TM45.js";
import {
  BaseTexture
...
import {
  DumpDataAsync
} from "./chunk-QGBIWE6V.js";
import {
  Tools
} from "./chunk-TYGSBGED.js";
import {
  ILog2
...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRGBDTexture = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGPU) {
        await import("./rgbdDecode.fragment-V7XDJLPK.js");
      } else {
        await import("./rgbdDecode.fragment-YFRIMHZT.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-QAIO5EON.js");
    } else {
      await import("./rgbdEncode.fragment-KHSW5JIL.js");
    }
...
//# sourceMappingURL=chunk-XWSI4Y6G.js.map
