...
import {
  BaseTexture,
  Texture
} from "./chunk-MWN2RF5H.js";
import {
  SerializationHelper
} from "./chunk-QH4PDF2G.js";
import {
  __decorate,
  serialize,
  serializeAsColor4
...
import {
  ...
  Vector3,
  _ObserveArray
} from "./chunk-UWT2W7T7.js";
import {
  HasStencilAspect,
  ThinEngine,
  WebGLDataBuffer,
  WebGLHardwareTexture
} from "./chunk-FOT5C5NR.js";
import {
  EffectWrapper
} from "./chunk-LBSOSK6E.js";
import {
  GetClass,
  RegisterClass
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-WPDDUOCZ.js").then((module) => this._dumpTools = module);
    }
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      list.push(Promise.all([import("./postprocess.vertex-3UJAON62.js")]));
    } else {
      list.push(Promise.all([import("./postprocess.vertex-EZVARNFQ.js")]));
    }
  }
  /**
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-ULGK2CPJ.js");
    const textures = [];
...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-BFQSYI6N.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-ER2N2NXK.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-7FMLSPSU.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-XX3NIMDL.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
var ProcessAsync = async (texture, width, height, face, lod) => {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      await import("./lodCube.fragment-PKD7DY76.js");
    } else {
      await import("./lod.fragment-PBPN7BKQ.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-R6WTFHHZ.js");
    } else {
      await import("./lod.fragment-X4A5T5MJ.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-RUM4TM45.js.map
